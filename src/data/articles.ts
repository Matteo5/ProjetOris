...
export const articles: Article[] = [
  ...
  },
  {
    ...
    body: `
      ...
      <p>Chez Oris, nous déployons des outils IA <em>supervisés</em> : vous gardez la main sur les cas ambigus et validez avant intégration dans votre comptabilité. L'IA accélère, elle ne décide pas à votre place.</p>
